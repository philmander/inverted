/**
 * Namespace utility
 * Shortcut to quadro.Namespace.set() is quadro.namespace()
 */
(function(global, inverted)
{
    inverted = inverted || {};
    inverted.ioc = inverted.ioc || {}; 
     ...
     * @param root {Object} The root object to build namespaces on
     */
    ...
    /**
     * Sets a namespace using a string. 
     * Eg: "one.two.three" will become
     * <code>
     * window.one = {
     *     two: {
     *          three: {}
     ...
     * 
     * @param packageName The namespace to set
